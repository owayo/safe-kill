...
- **Library Unit Tests**: 439 tests covering all modules. Ancestry traversal stop conditions (depth limit, parent-PID cycles, PID 1 termination) and missing direct ancestors are verified against injected process trees, since a real process tree cannot be made to exhibit them reliably.
